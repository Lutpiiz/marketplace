<div class="container">
	...
	<form method="post" enctype="multipart/form-data">
		...
		<div class="mb-3">
            ...
            <img src="<?php echo $this->config->item("url_produk").$produk["foto_produk"] ?>" alt="" width="200">
		</div>
		<div class="mb-3">
			<label>Deskripsi</label>
			<textarea class="form-control" name="deskripsi_produk"><?php echo $produk['harga_produk'] ?></textarea>
		</div>
